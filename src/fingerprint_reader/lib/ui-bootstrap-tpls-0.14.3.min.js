...
angular.module("ui.bootstrap", [
    ...
    function (a, b) {
      ...
      return {
        link: function (b, d, e) {
          ...
          function g() {
            d.removeClass("collapsing")
              .addClass("collapse")
              .css({ height: "auto" });
          }
          function h() {
            return d.hasClass("collapse") || d.hasClass("in")
              ? (d
                  .css({ height: d[0].scrollHeight + "px" })
                  .removeClass("collapse")
                  .addClass("collapsing")
                  .attr("aria-expanded", !1)
                  .attr("aria-hidden", !0),
                void (c
                  ? c(d, { removeClass: "in", to: { height: "0" } })
                      .start()
                      ["finally"](i)
                  : a.removeClass(d, "in", { to: { height: "0" } }).then(i)))
              : i();
          }
          function i() {
            d.css({ height: "0" }),
  ...
  angular
    ...
    .value("$collapseSuppressWarning", !1)
    .directive("collapse", [
      "$animate",
      "$injector",
      "$log",
      "$collapseSuppressWarning",
      function (a, b, c, d) {
          ...
          link: function (b, f, g) {
              ...
              f
                ...
                e
                  ? e(f, {
                      ...
                      .done(i)
                  : a
                      .animate(f, {}, { height: f[0].scrollHeight + "px" })
                      .then(i);
            }
            function i() {
            ...
            function j() {
              return f.hasClass("collapse") || f.hasClass("in")
                ? (f
                    .css({ height: f[0].scrollHeight + "px" })
            ...
            d ||
              c.warn("collapse is now deprecated. Use uib-collapse instead."),
  ...
  angular
    ...
    .value("$accordionSuppressWarning", !1)
    .controller("AccordionController", [
      ...
      function (a, b, c, d, e) {
        e ||
          ...
          angular.extend(
            this,
            c("UibAccordionController", { $scope: a, $attrs: b })
          );
      },
    ])
    .directive("accordion", [
      ...
      function (a, b) {
        return {
          ...
          link: function () {
            b ||
              a.warn("accordion is now deprecated. Use uib-accordion instead.");
          },
        };
      },
    ])
    ...
    .controller("AlertController", [
      ...
      function (a, b, c, d, e) {
        e ||
          ...
          angular.extend(
            this,
            c("UibAlertController", { $scope: a, $attrs: b })
          );
      },
    ])
    .directive("alert", [
        ...
        link: function (a, b, c, d) {
          ...
          b.find("input").css({ display: "none" }),
            (f.$render = function () {
              b.toggleClass(
                e.activeClass,
                angular.equals(f.$modelValue, a.$eval(c.uibBtnRadio))
              );
            }),
  ...
  angular
    .module("ui.bootstrap.buttons")
    .value("$buttonsSuppressWarning", !1)
    ...
    .directive("btnRadio", [
      ...
      function (a, b) {
        return {
          ...
          link: function (c, d, e, f) {
            b ||
              a.warn("btn-radio is now deprecated. Use uib-btn-radio instead.");
            var g = f[0],
              h = f[1];
            d.find("input").css({ display: "none" }),
              (h.$render = function () {
                d.toggleClass(
                  g.activeClass,
                  angular.equals(h.$modelValue, c.$eval(e.btnRadio))
                );
              }),
      ...
      function (a, b, c) {
        return {
          ...
          link: function (d, e, f, g) {
            ...
            var k = g[0],
              l = g[1];
            e.find("input").css({ display: "none" }),
              (l.$render = function () {
                e.toggleClass(
                  k.activeClass,
                  angular.equals(l.$modelValue, h())
                );
              }),
  ...
  angular
    ...
    .controller("UibCarouselController", [
      ...
      function (a, b, c, d) {
        function e(b, c, e) {
          s ||
            (angular.extend(b, { direction: e, active: !0 }),
            angular.extend(m.currentSlide || {}, { direction: e, active: !1 }),
            d.enabled() &&
              !a.noTransition &&
              !a.$currentTransition &&
              b.$element &&
              m.slides.length > 1 &&
              (b.$element.data(q, b.direction),
              m.currentSlide &&
                m.currentSlide.$element &&
                m.currentSlide.$element.data(q, b.direction),
              (a.$currentTransition = !0),
              o
                ? d.on("addClass", b.$element, function (b, c) {
                    "close" === c &&
                      ((a.$currentTransition = null), d.off("addClass", b));
                  })
        ...
        (m.select = a.select =
          ...
          (m.getCurrentIndex = function () {
            return m.currentSlide && angular.isDefined(m.currentSlide.index)
              ? +m.currentSlide.index
              : r;
          }),
    ...
    .animation(".item", [
      ...
      function (a, b) {
        ...
        var d = "uib-noTransition",
          ...
          f = null;
        return (
          a.has("$animateCss") && (f = a.get("$animateCss")),
          {
  ...
  angular
    .module("ui.bootstrap.carousel")
    .value("$carouselSuppressWarning", !1)
    .controller("CarouselController", [
      ...
      function (a, b, c, d, e) {
        e ||
          ...
          angular.extend(
            this,
            c("UibCarouselController", { $scope: a, $element: b })
          );
      },
    ])
    .directive("carousel", [
      ...
      function (a, b) {
        return {
          ...
          link: function () {
            b ||
              a.warn("carousel is now deprecated. Use uib-carousel instead.");
          },
        };
      },
    ])
    ...
    function (a, b, c) {
      function d(a) {
        var b = [],
          d = a.split("");
        return (
          angular.forEach(g, function (c, e) {
            var f = a.indexOf(e);
            if (f > -1) {
      ...
      (this.init = function () {
        ...
        (this.parse = function (c, g, i) {
          ...
          if (m && m.length) {
            var n, o;
            angular.isDate(i) && !isNaN(i.getTime())
              ? (n = {
                  year: i.getFullYear(),
                  month: i.getMonth(),
                  date: i.getDate(),
  ...
  angular
    ...
    .value("$dateParserSuppressWarning", !1)
    .service("dateParser", [
      "$log",
      "$dateParserSuppressWarning",
      "uibDateParser",
      function (a, b, c) {
  ...
  angular
    ...
    .value("$positionSuppressWarning", !1)
    .service("$position", [
      "$log",
      "$positionSuppressWarning",
      "$uibPosition",
      function (a, b, c) {
            ...
            b[d]
              ? a.$parent.$watch(c(b[d]), function (c) {
                  (i[d] = angular.isDefined(c) ? c : b[d]),
                    (a[d] = i[d]),
                    (("minMode" == d &&
                      i.modes.indexOf(a.datepickerMode) <
                        i.modes.indexOf(i[d])) ||
                      ("maxMode" == d &&
                        i.modes.indexOf(a.datepickerMode) >
                          i.modes.indexOf(i[d]))) &&
          ...
          angular.isDefined(b.initDate)
            ? ((this.activeDate = a.$parent.$eval(b.initDate) || new Date()),
              a.$parent.$watch(b.initDate, function (a) {
                a &&
                  (j.$isEmpty(j.$modelValue) || j.$invalid) &&
        ...
        (this.element = b),
          ...
          (this._refreshView = function () {
            for (
              var b,
                c = new Array(e),
                f = 0,
                g = d(this.activeDate.getFullYear());
              e > f;
              f++
            )
              (b = new Date(this.activeDate)),
          ...
          (this.handleKeyDown = function (a, b) {
            ...
            "left" === a
              ...
              ? (c += 5)
              : "pageup" === a || "pagedown" === a
              ? (c += ("pageup" === a ? -1 : 1) * this.step.years)
              : "home" === a
              ? (c = d(this.activeDate.getFullYear()))
              : "end" === a && (c = d(this.activeDate.getFullYear()) + e - 1),
      ...
      function (a, b, c, d, e, f, g, h, i, j, k, l) {
        ...
        (a.watchData = {}),
          (this.init = function (h) {
            if (
              ((z = h),
              (s = angular.isDefined(c.closeOnDateSelection)
                ? a.$parent.$eval(c.closeOnDateSelection)
                : k.closeOnDateSelection),
              (t = angular.isDefined(c.datepickerAppendToBody)
                ? a.$parent.$eval(c.datepickerAppendToBody)
                : k.appendToBody),
              (u = angular.isDefined(c.onOpenFocus)
                ? a.$parent.$eval(c.onOpenFocus)
                : k.onOpenFocus),
              (v = angular.isDefined(c.datepickerPopupTemplateUrl)
                ? c.datepickerPopupTemplateUrl
                : k.datepickerPopupTemplateUrl),
              (w = angular.isDefined(c.datepickerTemplateUrl)
                ? c.datepickerTemplateUrl
                : k.datepickerTemplateUrl),
              (a.showButtonBar = angular.isDefined(c.showButtonBar)
                ? a.$parent.$eval(c.showButtonBar)
                : k.showButtonBar),
              k.html5Types[c.type]
                ? ((r = k.html5Types[c.type]), (C = !0))
                : ((r =
                    c.datepickerPopup ||
                    c.uibDatepickerPopup ||
                    k.datepickerPopup),
                  c.$observe("uibDatepickerPopup", function (a, b) {
                    var c = a || k.datepickerPopup;
                    if (c !== r && ((r = c), (z.$modelValue = null), !r))
                      throw new Error(
          ...
          (a.isDisabled = function (b) {
            return (
              "today" === b && (b = new Date()),
              (a.watchData.minDate && a.compare(b, B.minDate) < 0) ||
                (a.watchData.maxDate && a.compare(b, B.maxDate) > 0)
            );
          }),
          ...
          (a.select = function (b) {
            if ("today" === b) {
              ...
              angular.isDate(a.date)
                ? ((b = new Date(a.date)),
                  b.setFullYear(c.getFullYear(), c.getMonth(), c.getDate()))
          ...
          a.$watch("isOpen", function (c) {
            c
              ? ((a.position = t ? h.offset(b) : h.position(b)),
  ...
  angular
    .module("ui.bootstrap.datepicker")
    .value("$datepickerSuppressWarning", !1)
        ...
        (this.modes = ["day", "month", "year"]),
            ...
            b[d]
              ? a.$parent.$watch(c(b[d]), function (c) {
                  (j[d] = angular.isDefined(c) ? c : b[d]),
                    (a[d] = j[d]),
                    (("minMode" == d &&
                      j.modes.indexOf(a.datepickerMode) <
                        j.modes.indexOf(j[d])) ||
                      ("maxMode" == d &&
                        j.modes.indexOf(a.datepickerMode) >
                          j.modes.indexOf(j[d]))) &&
                      (a.datepickerMode = j[d]);
                })
          ...
          angular.isDefined(b.initDate)
            ? ((this.activeDate = a.$parent.$eval(b.initDate) || new Date()),
              a.$parent.$watch(b.initDate, function (a) {
                a &&
                  (k.$isEmpty(k.$modelValue) || k.$invalid) &&
                  ((j.activeDate = a), j.refreshView());
              }))
            : (this.activeDate = new Date()),
          (a.isActive = function (b) {
            return 0 === j.compare(b.date, j.activeDate)
              ? ((a.activeDateId = b.uid), !0)
              : !1;
          }),
          (this.init = function (a) {
          ...
          (a.select = function (b) {
            if (a.datepickerMode === j.minMode) {
              ...
              (j.activeDate = b),
                (a.datepickerMode =
                  j.modes[j.modes.indexOf(a.datepickerMode) - 1]);
          }),
          (a.move = function (a) {
          ...
          (a.toggleMode = function (b) {
            (b = b || 1),
              (a.datepickerMode === j.maxMode && 1 === b) ||
                (a.datepickerMode === j.minMode && -1 === b) ||
                (a.datepickerMode =
          ...
          (a.keydown = function (b) {
            ...
            if (c && !b.shiftKey && !b.altKey)
              if (
                ...
                !b.ctrlKey || ("up" !== c && "down" !== c)
                  ? (j.handleKeyDown(c, b), j.refreshView())
                  : a.toggleMode("up" === c ? 1 : -1);
          });
      },
    ])
    ...
    .directive("daypicker", [
      ...
      function (a, b) {
        return {
          ...
          link: function (c, d, e, f) {
            b ||
              a.warn("daypicker is now deprecated. Use uib-daypicker instead.");
            var g = f[0],
              h = f[1];
            h.init(g);
          },
  ...
  angular
    ...
    .constant("uibDropdownConfig", { openClass: "open" })
    .service("uibDropdownService", [
      ...
      function (a, b) {
        ...
        (this.open = function (b) {
          c || (a.bind("click", d), a.bind("keydown", e)),
            c && c !== b && (c.isOpen = !1),
            (c = b);
        }),
          (this.close = function (b) {
            c === b &&
              ((c = null), a.unbind("click", d), a.unbind("keydown", e));
          });
        var d = function (a) {
        ...
        b.addClass("dropdown"),
          (this.init = function () {
            c.isOpen &&
              ...
              s &&
                n.dropdownMenu &&
                (i.find("body").append(n.dropdownMenu),
          ...
          (o.focusDropdownEntry = function (a) {
            var c = n.dropdownMenu
              ? angular.element(n.dropdownMenu).find("a")
              : angular.element(b).find("ul").eq(0).find("a");
            switch (a) {
              case 40:
              ...
              case 38:
                angular.isNumber(n.selectedOption)
                  ? (n.selectedOption =
                      0 === n.selectedOption ? 0 : n.selectedOption - 1)
                  : (n.selectedOption = c.length - 1);
            }
          ...
          o.$watch("isOpen", function (c, d) {
            if (s && n.dropdownMenu) {
              var e = h.positionElements(b, n.dropdownMenu, "bottom-left", !0),
                i = { top: e.top + "px", display: c ? "block" : "none" },
                m = n.dropdownMenu.hasClass("dropdown-menu-right");
              m
                ? ((i.left = "auto"),
                  (i.right =
                    window.innerWidth -
                    (e.left + b.prop("offsetWidth")) +
                    "px"))
                : ((i.left = e.left + "px"), (i.right = "auto")),
                n.dropdownMenu.css(i);
            }
            if (
              (g[c ? "addClass" : "removeClass"](b, p).then(function () {
            ...
            if (-1 !== [38, 40].indexOf(a.which)) {
              ...
              switch (a.which) {
                ...
                case 38:
                  angular.isNumber(d.selectedOption)
                    ? (d.selectedOption =
                        0 === d.selectedOption ? 0 : d.selectedOption - 1)
                    : (d.selectedOption = b.length - 1);
              }
  ...
  angular
    ...
    .value("$dropdownSuppressWarning", !1)
      ...
      function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
        ...
        b.addClass("dropdown"),
          ...
          q.$watch("isOpen", function (c, d) {
            ...
            if (
              (g[c ? "addClass" : "removeClass"](b, r).then(function () {
                angular.isDefined(c) && c !== d && t(a, { open: !!c });
              }),
              c)
            )
              p.dropdownMenuTemplateUrl &&
                k(p.dropdownMenuTemplateUrl).then(function (a) {
                  (n = q.$new()),
    ...
    .directive("dropdown", [
      ...
      function (a, b) {
        return {
          ...
          link: function (c, d, e, f) {
            b ||
              a.warn("dropdown is now deprecated. Use uib-dropdown instead."),
              f.init();
          },
        };
      },
                ...
                if (-1 !== [38, 40].indexOf(a.which)) {
                  ...
                  switch (a.which) {
                    ...
                    case 38:
                      angular.isNumber(f.selectedOption)
                        ? (f.selectedOption =
                            0 === f.selectedOption ? 0 : f.selectedOption - 1)
                        : (f.selectedOption = b.length - 1);
                  }
        ...
        return {
          ...
          link: function (c, d, e, f) {
            if (
              ...
              d.bind("click", g),
                d.attr({ "aria-haspopup": !0, "aria-expanded": !1 }),
  ...
  angular
    .module("ui.bootstrap.modal", ["ui.bootstrap.stackedMap"])
      ...
      function (a, b, c) {
        function d(b, d, f) {
          d.addClass("modal-backdrop"),
            f.modalInClass &&
              (e
                ? e(d, { addClass: f.modalInClass }).start()
                : a.addClass(d, f.modalInClass),
              b.$on(c.NOW_CLOSING_EVENT, function (b, c) {
                var g = c();
                e
                  ? e(d, { removeClass: f.modalInClass }).start().then(g)
                  : a.removeClass(d, f.modalInClass).then(g);
              }));
        }
        var e = null;
        return (
          b.has("$animateCss") && (e = b.get("$animateCss")),
          {
            replace: !0,
    ...
    .directive("uibModalWindow", [
      ...
      function (a, b, c, d) {
        var e = null;
        return (
          d.has("$animateCss") && (e = d.get("$animateCss")),
          {
            scope: { index: "@" },
            replace: !0,
            transclude: !0,
            ...
            link: function (d, f, g) {
              ...
              g.$observe("modalRender", function (a) {
                ...
                h.promise.then(function () {
                  ...
                  g.modalInClass &&
                    ((h = e
                      ? e(f, { addClass: g.modalInClass }).start()
                      : c.addClass(f, g.modalInClass)),
                    d.$on(a.NOW_CLOSING_EVENT, function (a, b) {
                      var d = b();
                      e
                        ? e(f, { removeClass: g.modalInClass }).start().then(d)
    ...
    .factory("$uibModalStack", [
      ...
      function (a, b, c, d, e, f, g, h, i) {
        ...
        var q,
          ...
          u = i.createNew(),
          v = h.createNew(),
          w = { NOW_CLOSING_EVENT: "modal.stack.now-closing" },
          x = 0,
          y =
        ...
        return (
            ...
            if (b && b.value.keyboard)
              switch (a.which) {
                ...
                case 9:
                  ...
                  var c = !1;
                  a.shiftKey
                    ? w.isFocusInFirstItem(a) &&
                      (c = w.focusLastFocusableElement())
                    : w.isFocusInLastItem(a) &&
                      (c = w.focusFirstFocusableElement()),
          ...
          (w.isFocusInLastItem = function (a) {
            return s.length > 0
              ? (a.target || a.srcElement) == s[s.length - 1]
              : !1;
          }),
          ...
          function (b, c, d, e, f, g, h, i) {
            ...
            return (
              ...
              (l.open = function (b) {
                ...
                var q,
                  r = d.all([j(b)].concat(k(b.resolve)));
                return (
                  (q = m =
                    d
                      .all([m])
                      ...
                      .then(
                        function (a) {
                          ...
                          b.controller &&
                            ...
                            (e = f(b.controller, j)),
                            b.controllerAs &&
                              (b.bindToController && angular.extend(e, d),
                              (d[b.controllerAs] = e))),
                            g.open(p, {
                              scope: d,
                              deferred: l,
  ...
  angular
      ...
      function (a, b, c, d, e) {
        function f(b, f, h) {
          e ||
            ...
            h.modalInClass &&
              (g
                ? g(f, { addClass: h.modalInClass }).start()
                : a.addClass(f, h.modalInClass),
              b.$on(c.NOW_CLOSING_EVENT, function (b, c) {
                var d = c();
                g
                  ? g(f, { removeClass: h.modalInClass }).start().then(d)
                  : a.removeClass(f, h.modalInClass).then(d);
              }));
        }
        var g = null;
        return (
          b.has("$animateCss") && (g = b.get("$animateCss")),
          {
            replace: !0,
            templateUrl: "template/modal/backdrop.html",
            compile: function (a, b) {
    ...
    .directive("modalWindow", [
      ...
      function (a, b, c, d, e, f) {
        var g = null;
        return (
          d.has("$animateCss") && (g = d.get("$animateCss")),
          {
            scope: { index: "@" },
            replace: !0,
            transclude: !0,
            ...
            link: function (d, h, i) {
              ...
              i.$observe("modalRender", function (a) {
                ...
                j.promise.then(function () {
                  ...
                  i.modalInClass &&
                    ((e = g
                      ? g(h, { addClass: i.modalInClass }).start()
                      : c.addClass(h, i.modalInClass)),
                    d.$on(a.NOW_CLOSING_EVENT, function (a, b) {
                      var d = b();
                      g
                        ? g(h, { removeClass: i.modalInClass }).start().then(d)
                        : c.removeClass(h, i.modalInClass).then(d);
                    })),
    ...
    .service("$modalStack", [
      ...
      function (a, b, c, d, e, f, g, h, i, j, k, l) {
        l ||
          k.warn("$modalStack is now deprecated. Use $uibModalStack instead."),
      ...
      function (a) {
        angular.extend(this, a),
          (this.$get = [
            ...
            function (b, c, d) {
              return (
                d || c.warn("$modal is now deprecated. Use $uibModal instead."),
                b.invoke(a.$get)
              );
            },
          ]);
  ...
  angular
    .module("ui.bootstrap.pagination")
    .value("$paginationSuppressWarning", !1)
        ...
        return {
          ...
          link: function (e, f, g, h) {
            ...
            function j(a, b) {
              ...
              f &&
                (n
                  ? ((d = Math.max(a - Math.floor(m / 2), 1)),
                    (e = d + m - 1),
                    e > b && ((e = b), (d = e - m + 1)))
                  : ((d = (Math.ceil(a / m) - 1) * m + 1),
                    (e = Math.min(d + m - 1, b))));
              for (var g = d; e >= g; g++) {
                var h = i(g, g, g === a);
                c.push(h);
            ...
            var k = h[0],
              l = h[1];
            if (l) {
              var m = angular.isDefined(g.maxSize)
                  ? e.$parent.$eval(g.maxSize)
                  : b.maxSize,
                n = angular.isDefined(g.rotate)
                  ? e.$parent.$eval(g.rotate)
                  : b.rotate;
              (e.boundaryLinks = angular.isDefined(g.boundaryLinks)
                ? e.$parent.$eval(g.boundaryLinks)
                : b.boundaryLinks),
                (e.directionLinks = angular.isDefined(g.directionLinks)
                  ? e.$parent.$eval(g.directionLinks)
                  : b.directionLinks),
                k.init(l, b),
                g.maxSize &&
                  e.$parent.$watch(a(g.maxSize), function (a) {
        ...
        return {
          ...
          link: function (d, e, f, g) {
            ...
            var h = g[0],
              i = g[1];
            i &&
              ((d.align = angular.isDefined(f.align)
                ? d.$parent.$eval(f.align)
                : a.align),
              h.init(i, a));
          },
        };
                    ...
                    return function (a, b, d, f) {
                      ...
                      function m() {
                        (!K || a.$eval(d[k + "Enable"])) &&
                          ...
                          x(),
                          L.popupDelay
                            ? F || (F = g(r, L.popupDelay, !1))
                            : r());
                      }
                      function q() {
                        s(),
                          L.popupCloseDelay
                            ? G || (G = g(t, L.popupCloseDelay, !1))
                            : t();
                      }
                      function r() {
                        return (
                      ...
                      function B() {
                        ...
                        R(),
                          (J = p(a)),
                          "none" !== J.show &&
                            J.show.forEach(function (a, c) {
                              a === J.hide[c]
                                ? b[0].addEventListener(a, j)
                                : a &&
                                  (b[0].addEventListener(a, m),
                      ...
                      var C,
                        ...
                        G,
                        H,
                        I = angular.isDefined(o.appendToBody)
                          ? o.appendToBody
                          : !1,
                        J = p(void 0),
                        ...
                        L = a.$new(!0),
                        M = !1,
                        N = angular.isDefined(d[k + "IsOpen"])
                          ? l(d[k + "IsOpen"])
                          : !1,
  ...
  angular
    .module("ui.bootstrap.tooltip")
    .value("$tooltipSuppressWarning", !1)
    .provider("$tooltip", [
      "$uibTooltipProvider",
      function (a) {
        angular.extend(this, a),
        ...
        return {
          link: function (g, h, i) {
            ...
            var j,
              k,
              l,
              m = g.$eval(i.tooltipTemplateTranscludeScope),
              n = 0,
              o = function () {
                k && (k.remove(), (k = null)),
                  j && (j.$destroy(), (j = null)),
            ...
            g.$watch(
              b.parseAsResourceUrl(i.tooltipTemplateTransclude),
              function (b) {
                var e = ++n;
                b
                  ? (d(b, !0).then(
                    ...
                    g.$emit("$includeContentRequested", b))
                  : o();
              }
            ),
              g.$on("$destroy", o);
    ...
    .directive("tooltipTemplatePopup", [
      "$log",
      "$tooltipSuppressWarning",
      function (a, b) {
        return {
  ...
  angular
    ...
    .value("$popoverSuppressWarning", !1)
    .directive("popoverTemplatePopup", [
      "$log",
      "$popoverSuppressWarning",
      function (a, b) {
        return {
          replace: !0,
          scope: {
        ...
        (this.bars = []),
          ...
          (this.addBar = function (b, c, f) {
            e || c.css({ transition: "none" }),
              ...
              (b.max = a.max),
              (b.title =
                f && angular.isDefined(f.title) ? f.title : "progressbar"),
  ...
  angular
    ...
    .controller("ProgressController", [
      ...
      function (a, b, c, d, e) {
        ...
        var f = this,
          g = angular.isDefined(b.animate)
            ? a.$parent.$eval(b.animate)
            : c.animate;
        (this.bars = []),
          (a.max = angular.isDefined(a.max) ? a.max : c.max),
          (this.addBar = function (b, c, d) {
            g || c.css({ transition: "none" }),
              this.bars.push(b),
              (b.max = a.max),
              (b.title =
                d && angular.isDefined(d.title) ? d.title : "progressbar"),
              b.$watch("value", function (a) {
                b.recalculatePercentage();
              }),
              (b.recalculatePercentage = function () {
        ...
        return {
          ...
          link: function (c, d, e, f) {
            b ||
              ...
              f.addBar(c, angular.element(d.children()[0]), { title: e.title });
          },
        };
      },
    ]),
        ...
        (this.init = function (e) {
          ...
          (a.rate = function (b) {
            !a.readonly &&
              b >= 0 &&
              b <= a.range.length &&
              (d.$setViewValue(d.$viewValue === b ? 0 : b), d.$render());
          }),
          (a.enter = function (b) {
  ...
  angular
    .module("ui.bootstrap.rating")
    .value("$ratingSuppressWarning", !1)
    .controller("RatingController", [
      "$scope",
      "$attrs",
      "$controller",
      "$log",
      "$ratingSuppressWarning",
      function (a, b, c, d, e) {
        e ||
          d.warn(
          ...
          angular.extend(
            this,
            c("UibRatingController", { $scope: a, $attrs: b })
          );
      },
    ])
    .directive("rating", [
      ...
      function (a) {
        ...
        (b.select = function (a) {
          angular.forEach(c, function (b) {
            b.active &&
              b !== a &&
              ((b.active = !1), b.onDeselect(), (a.selectCalled = !1));
          }),
            (a.active = !0),
            a.selectCalled || (a.onSelect(), (a.selectCalled = !0));
        }),
          (b.addTab = function (a) {
            c.push(a),
              1 === c.length && a.active !== !1
                ? (a.active = !0)
                : a.active
                ? b.select(a)
                : (a.active = !1);
          ...
          link: function (c, d, e) {
            b || a.warn("tabset is now deprecated. Use uib-tabset instead."),
              (c.vertical = angular.isDefined(e.vertical)
                ? c.$parent.$eval(e.vertical)
                : !1),
              (c.justified = angular.isDefined(e.justified)
                ? c.$parent.$eval(e.justified)
                : !1);
          },
        };
      },
        ...
        return {
          ...
          link: function (d, e, f, g, h) {
            c || b.warn("tab is now deprecated. Use uib-tab instead."),
              ...
              (d.disabled = !1),
              f.disable &&
                d.$parent.$watch(a(f.disable), function (a) {
                  d.disabled = !!a;
                }),
              (d.select = function () {
  ...
  angular
    ...
    .controller("UibTimepickerController", [
      ...
      function (a, b, c, d, e, f, g) {
        ...
        var p = new Date(),
          q = { $setViewValue: angular.noop },
          r = angular.isDefined(c.meridians)
        ...
        (a.tabindex = angular.isDefined(c.tabindex) ? c.tabindex : 0),
          ...
          (this.init = function (b, d) {
            ...
            var e = d.eq(0),
              f = d.eq(1),
              h = angular.isDefined(c.mousewheel)
                ? a.$parent.$eval(c.mousewheel)
                : g.mousewheel;
            h && this.setupMousewheelEvents(e, f);
            var i = angular.isDefined(c.arrowkeys)
            ...
            (a.updateHours = function () {
              ...
              (a.updateMinutes = function () {
                var a = i(),
                  b = h();
                angular.isDefined(a) && angular.isDefined(b)
                  ? (p.setMinutes(a), u > p || p > v ? d(void 0, !0) : k("m"))
                  : d(void 0, !0);
              }),
  ...
  angular
    .module("ui.bootstrap.timepicker")
    .value("$timepickerSuppressWarning", !1)
    .controller("TimepickerController", [
      ...
      function (a, b, c, d, e, f) {
        f ||
          ...
          angular.extend(
            this,
            d("UibTimepickerController", { $scope: a, $element: b, $attrs: c })
          );
      },
    ])
  ...
  angular
    ...
    .controller("UibTypeaheadController", [
      ...
      function (a, b, c, d, e, f, g, h, i, j, k, l) {
        function m() {
          K.moveInProgress || ((K.moveInProgress = !0), K.$digest()),
            S && g.cancel(S),
            (S = g(function () {
        ...
        var t,
          ...
          H = e(c.ngModel + "($$$p)"),
          I = function (b, c) {
            return angular.isFunction(G(a)) &&
              p &&
              p.$options &&
              p.$options.getterSetter
              ? H(b, { $$$p: c })
              : G.assign(b, c);
          },
        ...
        N.attr({
          ...
          angular.isDefined(c.typeaheadTemplateUrl) &&
            N.attr("template-url", c.typeaheadTemplateUrl),
          angular.isDefined(c.typeaheadPopupTemplateUrl) &&
            N.attr("popup-template-url", c.typeaheadPopupTemplateUrl);
        var O = function () {
        ...
        K.$watch("activeIdx", function (a) {
          0 > a
            ...
            : b.attr("aria-activedescendant", P(a));
        });
        var Q = function (a, b) {
            return K.matches.length > b && a
              ? a.toUpperCase() === K.matches[b].label.toUpperCase()
              : !1;
          },
          R = function (c) {
            var d = { $viewValue: c };
        ...
        O(),
          (K.select = function (d) {
            ...
            (u = !0),
              ...
              y(a, { $item: f, $model: e, $label: J.viewMapper(a, h) }),
              O(),
              K.$eval(c.typeaheadFocusOnSelect) !== !1 &&
                g(
                  function () {
                    b[0].focus();
                  },
          ...
          b.bind("keydown", function (a) {
            if (0 !== K.matches.length && -1 !== q.indexOf(a.which)) {
              if (-1 === K.activeIdx && (9 === a.which || 13 === a.which))
                return O(), void K.$digest();
              a.preventDefault(),
                40 === a.which
                  ? ((K.activeIdx = (K.activeIdx + 1) % K.matches.length),
                    K.$digest())
                  : 38 === a.which
                  ? ((K.activeIdx =
                      (K.activeIdx > 0 ? K.activeIdx : K.matches.length) - 1),
                    K.$digest())
        ...
        h.bind("click", W),
          a.$on("$destroy", function () {
            h.unbind("click", W),
              (C || D) && X.remove(),
              C &&
                (angular.element(i).unbind("resize", m),
                h.find("body").unbind("scroll", m)),
              N.remove();
          });
        var X = d(N)(K);
        C
          ? h.find("body").append(X)
          : D !== !1
          ? angular.element(h[0].getElementById(D)).append(X)
          : b.after(X),
              ...
              o.$parsers.unshift(function (b) {
                return (
                  ...
                  w
                    ? b
                    : b
                    ? void o.$setValidity("editable", !1)
                    : (o.$setValidity("editable", !0), null)
                );
              }),
    ...
    .directive("uibTypeaheadPopup", function () {
      return {
        ...
        templateUrl: function (a, b) {
          return (
            b.popupTemplateUrl || "template/typeahead/typeahead-popup.html"
          );
        },
        link: function (a, b, c) {
      ...
      function (a, b, c, d, e, f, g, h, i, j, k) {
        ...
        return {
          ...
          link: function (n, o, p, q) {
            ...
            k ||
              j.warn("typeahead is now deprecated. Use uib-typeahead instead.");
            var t = q[0],
              u = q[1],
            ...
            var w,
              ...
              C = angular.isDefined(p.typeaheadSelectOnBlur)
                ? n.$eval(p.typeaheadSelectOnBlur)
                : !1,
              D = b(p.typeaheadNoResults).assign || angular.noop,
              E = p.typeaheadInputFormatter
                ? b(p.typeaheadInputFormatter)
                : void 0,
              F = p.typeaheadAppendToBody
                ? n.$eval(p.typeaheadAppendToBody)
                : !1,
              G = p.typeaheadAppendToElementId || !1,
              H = n.$eval(p.typeaheadFocusFirst) !== !1,
              I = p.typeaheadSelectOnExact
                ? n.$eval(p.typeaheadSelectOnExact)
                : !1,
              J = b(p.ngModel),
              K = b(p.ngModel + "($$$p)"),
              L = function (a, b) {
                return angular.isFunction(J(n)) &&
                  u &&
                  u.$options &&
                  u.$options.getterSetter
                  ? K(a, { $$$p: b })
                  : J.assign(a, b);
              },
            ...
            N.$on("$destroy", O);
            var P =
              "typeahead-" + N.$id + "-" + Math.floor(1e4 * Math.random());
            o.attr({
              "aria-autocomplete": "list",
              "aria-expanded": !1,
              "aria-owns": P,
            ...
            N.$watch("activeIdx", function (a) {
              0 > a
                ? o.removeAttr("aria-activedescendant")
                : o.attr("aria-activedescendant", S(a));
            });
            var T = function (a, b) {
                return N.matches.length > b && a
                  ? a.toUpperCase() === N.matches[b].label.toUpperCase()
                  : !1;
              },
              U = function (a) {
                var b = { $viewValue: a };
            ...
            t.$parsers.unshift(function (a) {
              ...
              (N.select = function (a) {
                ...
                (x = !0),
                  ...
                  B(n, { $item: c, $model: b, $label: M.viewMapper(n, e) }),
                  R(),
                  N.$eval(p.typeaheadFocusOnSelect) !== !1 &&
                    d(
                      function () {
                        o[0].focus();
                      },
              ...
              o.bind("keydown", function (a) {
                if (0 !== N.matches.length && -1 !== l.indexOf(a.which)) {
                  if (-1 === N.activeIdx && (9 === a.which || 13 === a.which))
                    return R(), void N.$digest();
                  a.preventDefault(),
                    40 === a.which
                      ? ((N.activeIdx = (N.activeIdx + 1) % N.matches.length),
                        N.$digest())
                      : 38 === a.which
                      ? ((N.activeIdx =
                          (N.activeIdx > 0 ? N.activeIdx : N.matches.length) -
                          1),
                        N.$digest())
                      : 13 === a.which || 9 === a.which
                      ? N.$apply(function () {
            ...
            e.bind("click", Z),
              n.$on("$destroy", function () {
                e.unbind("click", Z),
                  (F || G) && $.remove(),
                  F &&
                    (angular.element(f).unbind("resize", r),
            ...
            F
              ? e.find("body").append($)
              : G !== !1
              ? angular.element(e[0].getElementById(G)).append($)
              : o.after($);
          },
        };
      },
